 ...
 */ !(function () {
	...
	function t() {
		function e(e) {
			((e = e || {}),
				((l = l || (void 0 !== e ? e : {})).ready = new Promise(
					function (e, n) {
						((T = e), (i = n));
					},
				)),
			...
			function X(e, n, t) {
				var r = n + t;
				for (t = n; e[t] && !(r <= t);) ++t;
				if (16 < t - n && e.subarray && K)
					return K.decode(e.subarray(n, t));
				for (r = ""; n < t;) {
					var o,
						i,
						a = e[n++];
			...
			((l.preloadedImages = {}),
				...
				(w = "stockfish.wasm"),
				oe() ||
					((o = w), (w = l.locateFile ? l.locateFile(o, p) : p + o)));
			var ae = {
				6678104: function () {
					try {
						l.onDoneSearching();
			...
			function he() {
				if (!me) {
					...
					for (e in de)
						void 0 === de[e] ? delete n[e] : (n[e] = de[e]);
					var t = [];
			...
			function ge(e, n, t, r) {
				...
				var l,
					...
					f = {
						...
						"%I": function (e) {
							return (
								0 == (e = e.M) ? (e = 12) : 12 < e && (e -= 12),
								i(e, 2)
							);
						},
						"%j": function (e) {
							return i(
								e.L + ye(C(e.A + 1900) ? M : R, e.K - 1),
								3,
							);
						},
						"%m": function (e) {
						...
						"%U": function (e) {
							...
							return a(t, (e = new Date(e.A + 1900, e.K, e.L))) <
								0
								? i(
										Math.ceil(
											(31 -
				...
				for (c in ((t = t.replace(/%%/g, "\0\0")), f))
					t.includes(c) &&
						(t = t.replace(new RegExp(c, "g"), f[c](r)));
				return (
					(t = t.replace(/\0\0/g, "%")),
					(l = t),
					(p = Array(V(l) + 1)),
			...
			var P,
				...
				Me =
					...
					(l.___wasm_call_ctors = function () {
						return (l.___wasm_call_ctors = l.asm.t).apply(
							null,
							arguments,
						);
					}),
					...
					(l._isSearching = function () {
						return (l._isSearching = l.asm.w).apply(
							null,
							arguments,
						);
					}),
				...
				Re = (l.___errno_location = function () {
					return (Re = l.___errno_location = l.asm.y).apply(
						null,
						arguments,
					);
				}),
				...
				Oe = (l.stackRestore = function () {
					return (Oe = l.stackRestore = l.asm.C).apply(
						null,
						arguments,
					);
				}),
			...
			if (
				((l._asyncify_start_unwind = function () {
					return (l._asyncify_start_unwind = l.asm.G).apply(
						null,
						arguments,
					);
				}),
				(l._asyncify_stop_unwind = function () {
					return (l._asyncify_stop_unwind = l.asm.H).apply(
						null,
						arguments,
					);
				}),
				(l._asyncify_start_rewind = function () {
					return (l._asyncify_start_rewind = l.asm.I).apply(
						null,
						arguments,
					);
				}),
				(l._asyncify_stop_rewind = function () {
					return (l._asyncify_stop_rewind = l.asm.J).apply(
						null,
						arguments,
					);
				}),
	...
	function c() {
		for (; n.length && (!r._isSearching || !r._isSearching());)
			i(n.shift());
	}
	function f(e) {
				...
				e
					? require.main === module
						? ((s = require("path")),
							(a = s.join(
								__dirname,
								s.basename(__filename, s.extname(__filename)) +
									".wasm",
							)),
							(r = {
